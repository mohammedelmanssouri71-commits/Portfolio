...
import { fadeUpItem, pageStagger } from './components/portfolio/motionVariants';
  ...
  return (
    <>
      ...
      <main>
        ...
        >
          <motion.div className="hero__content" variants={pageStagger} initial="hidden" animate="show">
            <motion.p className="hero__availability" variants={fadeUpItem}>{data.hero.available}</motion.p>
            <motion.p className="hero__greeting" variants={fadeUpItem}>{data.hero.greeting}</motion.p>
            <motion.h1 className="hero__name" variants={fadeUpItem}>{data.name}</motion.h1>
            <motion.p className="hero__tagline" variants={fadeUpItem}>{data.hero.roles.join(' · ')}</motion.p>
            <motion.p className="hero__subtitle" variants={fadeUpItem}>{data.hero.subtitle}</motion.p>
            ...
            <motion.div className="hero__stats" variants={fadeUpItem}>
        ...
        <AnimatedSection id="experience" className="section-block section-alt">
          ...
          <motion.div className="timeline" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.25 }}>
